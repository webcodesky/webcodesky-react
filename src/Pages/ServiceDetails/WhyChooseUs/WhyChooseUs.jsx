      ...
      <Container>
        <div className="md:py-20 py-5 flex flex-col items-center">
          <div className="flex flex-col items-center max-w-[685.605px]">
            <h2 className="poppins font-bold text-[13px] uppercase text-[#F64B4B]">
              Why choose us
            </h2>
            <h2 className="poppins text-center sm:px-32 md:px-2">
            ...
            {whyChooseUsData.map((item, index) => (
              ...
              >
                ...
                <div className="icon-box-content w-[70%]">
                  <h3 className="title poppins text-[22px] pb-2">
                    {item.title}
                  </h3>
          ...
          <div className="whychooseusCTA flex md:flex-row flex-col md:justify-between items-center w-full md:py-12 py-4">
            <div className="content">
              <h2 className="poppins md:text-[32px] pb-2">
                Ready to launch your next project?
              </h2>
              <p className="poppins font-normal text-[18px] md:w-[550px]">
