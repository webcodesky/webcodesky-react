          ...
          <div className=" flex flex-col md:flex-row md:gap-[65px] gap-5">
            <div className="md:w-[724px]">
              <p className="text-[#292929] text-[20px] font-light leading-[24px] md:pt-2">
                ...
                hackathon Hackathons have been on my mind since I heard it was a
                good way to gain experience as a junior UX designer.{" "}
              </p>
              ...
              <div className="md:pt-[40px] md:pb-[37px] md:px-[43px] md:flex md:gap-3">
                ...
                <div>
                  ...
                  <input
                    className="md:w-[407px] md:h-[56px] flex-shrink-0 rounded-[49px] border border-[rgba(0,0,0,0.18)] bg-[#FFF] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] "
                    type="text"
                  />
              ...
              <div className="md:flex md:gap-[22px] md:py-[13px]">
                <div className="md:w-[60%]">
                  <p className="text-[#292929] text-[20px] font-light leading-[24px] md:py-[14px]">
                    ...
                    junior UX designer. As my portfolio. An intense way to learn
                    about the process and practice your designs skills — My 1st
                    hackathon Hackathons have been on my mind since I heard it
                    was a good way to gain experience as a junior UX designer.{" "}
                  </p>
                </div>
                <div>
            ...
            {/* Other Topic Section  */}
            <div className="md:w-[424px] bg-[#F5F5F5] rounded-[15px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] p-4">
