...
const BlogPost = () => {
  return (
    <Container>
        ...
        <div className=" mx-auto flex flex-col md:flex-row md:gap-[47px] gap-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <Link to="/blog-details">
              <div className="w-[359px] rounded-[15px] bg-[#F5F5F5] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex-shrink-0 p-4 h-[525px]">
                <div>
                  <img src={cardImg} alt="" />
                </div>
                ...
                <div className="flex gap-[30px]">
                  ...
                  <div className="flex gap-3">
                    ...
                    <p>
                      ...
                      >
                        <path
                          d="M4.27428 13.9516C3.72497 13.9516 3.19817 13.7195 2.80975 13.3064C2.42134 12.8933 2.20313 12.333 2.20312 11.7488C2.20313 11.1645 2.42134 10.6042 2.80975 10.1911C3.19817 9.77798 3.72497 9.5459 4.27428 9.5459C4.82358 9.5459 5.35039 9.77798 5.73881 10.1911C6.12722 10.6042 6.34543 11.1645 6.34543 11.7488C6.34543 12.333 6.12722 12.8933 5.73881 13.3064C5.35039 13.7195 4.82358 13.9516 4.27428 13.9516ZM11.1781 13.9516C10.6288 13.9516 10.102 13.7195 9.7136 13.3064C9.32518 12.8933 9.10697 12.333 9.10697 11.7488C9.10697 11.1645 9.32518 10.6042 9.7136 10.1911C10.102 9.77798 10.6288 9.5459 11.1781 9.5459C11.7274 9.5459 12.2542 9.77798 12.6427 10.1911C13.0311 10.6042 13.2493 11.1645 13.2493 11.7488C13.2493 12.333 13.0311 12.8933 12.6427 13.3064C12.2542 13.7195 11.7274 13.9516 11.1781 13.9516ZM18.082 13.9516C17.5327 13.9516 17.0059 13.7195 16.6174 13.3064C16.229 12.8933 16.0108 12.333 16.0108 11.7488C16.0108 11.1645 16.229 10.6042 16.6174 10.1911C17.0059 9.77798 17.5327 9.5459 18.082 9.5459C18.6313 9.5459 19.1581 9.77798 19.5465 10.1911C19.9349 10.6042 20.1531 11.1645 20.1531 11.7488C20.1531 12.333 19.9349 12.8933 19.5465 13.3064C19.1581 13.7195 18.6313 13.9516 18.082 13.9516Z"
                          fill="#191919"
                        />
                      </svg>
                    </p>
      ...
      {/* navigation */}
      <div className="flex justify-between md:pb-[105px] ">
        <div className="text-[#667085] text-[24px] font-medium leading-[20px] flex gap-2 justify-center items-center">
          <MdOutlineArrowBack />
          <h1>Previous</h1>
        </div>
        <div className="flex text-[#667085] text-[24px] font-medium leading-[20px] gap-1">
          <p className=" flex justify-center items-center w-[40px] text-[#ffffff] text-center text-[24px] font-medium leading-[20px] p-3 rounded-[8px] bg-[#7F56D9]">
            1
          </p>
          <p className="p-3 w-[40px]">2</p>
          <p className="p-3 w-[40px]">3</p>
          <p className="p-3 w-[40px]">...</p>
          <p className="p-3 w-[40px]">8</p>
          <p className="p-3 w-[40px]">9</p>
          <p className="p-3 w-[40px]">10</p>
        </div>
        <div className="text-[#667085] text-[24px] font-medium leading-[20px] flex gap-2 justify-center items-center">
          <h1>Next</h1>
