  ...
  return (
    <div className="relative bg-[#FFFFFF] flex flex-col justify-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-[10px] font-medium md:text-[16px] lg:text-[20px] tracking-[0.2px] text-left  md:pl-36 w-[80%] md:w-[550px] lg:w-[650px] 2xl:w-[700px]  text-[#737373] font-montserrat md:leading-[20px]">
