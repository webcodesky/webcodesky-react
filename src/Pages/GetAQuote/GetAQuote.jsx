          ...
          fetch("https://server.webcodesky.com/contact-users", {
            ...
            .then((data) => {
              if (data.insertedId) {
                ...
                Swal.fire({
                  icon: "success",
                  title: "Thank You for Request a Quote!",
  ...
  return (
    <>
      <div className="bg-[#F5F5F5] max-sm:pt-[100px]">
        <Container>
          <h1 className="text-[#F60] text-center text-[48px] md:text-[96px] md:pt-[120px]">
            Get A{" "}
            <span className="text-black  font-bold leading-none tracking-[-1.92px] md:tracking-[-3.84px]">
              Quote
            </span>
          </h1>
